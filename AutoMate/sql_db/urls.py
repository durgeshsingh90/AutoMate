...
from .views import list_tables, select_all_from_table, index, refresh_list_tables, refresh_select_all_from_table, get_db_connections
...
urlpatterns = [
    ...
    path('get_db_connections/', get_db_connections, name='get_db_connections'),  # Add this line
